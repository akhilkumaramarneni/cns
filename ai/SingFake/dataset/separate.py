...
authtoken = "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" # Fill in your auth token
...
default_output_dir = "./separated/mdx_extra/"
...
#         target_file_names.append(lines[0].strip() + ".flac")
    with open(log, "r") as f:
        for line in f:
            # Strip leading and trailing whitespace and add ".flac" to each line
            target_file_names.append(line.strip() + ".flac")
