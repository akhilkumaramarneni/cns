...
source_folder = "./separated/mdx_extra" # where the separated files are. This script assumes you have ran separate.py before, and *.vad are under the same folder with file name adhereing to the same logic as written in separate.py.

logs_folder = "./data" # It needs the *.log files (similar to separate.py)
